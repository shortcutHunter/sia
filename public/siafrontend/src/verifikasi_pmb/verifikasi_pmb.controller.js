(function() {
  ...
  angular
    ...
    .controller('VerifikasiPmbController', VerifikasiPmbController);

  VerifikasiPmbController.$inject = ['$q', 'dataservice', 'logger', '$scope', '$compile'];
  /* @ngInject */
  function VerifikasiPmbController($q, dataservice, logger, scope, compile) {
    var vm = this;
    vm.title = 'Verfikasi PMB';
    vm.table = 'pmb';
    vm.page = 0;
    vm.data = [];
    vm.pageData = {};
