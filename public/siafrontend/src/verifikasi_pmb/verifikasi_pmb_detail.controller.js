(function() {
  ...
  angular
    ...
    .controller('VerifikasiPmbDetailController', VerifikasiPmbDetailController);

  VerifikasiPmbDetailController.$inject = ['$q', 'dataservice', 'logger', '$stateParams', '$scope', '$compile', '$element', '$state'];
  /* @ngInject */
  function VerifikasiPmbDetailController($q, dataservice, logger, stateParams, scope, compile, element, state) {
    var vm = this;
    vm.title = 'Detail PMB';
    vm.table = 'pmb';
    vm.data = {};
