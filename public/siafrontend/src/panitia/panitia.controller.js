(function() {
  ...
  angular
    .module('app.panitia')
    .controller('PanitiaController', PanitiaController);

  PanitiaController.$inject = ['$q', 'dataservice', 'logger', '$scope'];
  /* @ngInject */
  function PanitiaController($q, dataservice, logger, scope) {
    var vm = this;
    vm.title = 'Panitia';
    vm.table = 'panitia';
    vm.page = 0;
